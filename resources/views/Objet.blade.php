...
<div class="offcanvas offcanvas-start " data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
    ...
    <div class="offcanvas-body">
        <form action="/objet" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                            ...
                            <a href="{{ asset('/storage/photos/' . $photo->path) }}" target="_blank">
                                ...
                                <div class="form-group actions" style="display: none;">
                                    <div class="form-group" style="display: flex; justify-content: center;">
                                        ...
                                        <a href="{{ route('ListerObjet', $photo->id) }}" class="icon-link d-inline"><i class="fas fa-search"></i></a>
...
function toggleGetDescriptorsButton() {
    ...
    $('#Showtheme').change(function () {
        var selectedTheme = $(this).val();
        window.location.href = '{{ route("objet") }}?theme=' + selectedTheme;
    });
});
